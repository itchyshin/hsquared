...
| `hs_data()` container | partial | local tests over phenotype, pedigree, genotype, expression, marker inputs, ID overlap summaries, and v0.1 parser use | No file-backed storage or automatic genotype/omics model construction yet. |
