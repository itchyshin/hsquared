...
| `hs_data()` input container | partial | local ID-map, pedigree-status summary, marker-map validation, genotype-marker alignment, ID-overlap summary, marker-status summary, parser integration, and input-shape tests | Emmy/Jason | No large-file, file-backed, PLINK/VCF, genotype parsing, imputation, pedigree inverse, or marker-scan tests yet. |
