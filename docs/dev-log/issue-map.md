...
| 25 | Innovation: SQUAREM EM accelerator (engine utility) | — | innovation/perf | planned | engine-led; twin #58; live issue body now pins this as a planned EM/fixed-point utility only, gated on same fixed point plus guarded/backtracking objective behaviour before any iteration/time claim |
