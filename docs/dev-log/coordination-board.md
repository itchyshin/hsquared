...
| 2026-06-13 | R | Emmy/Jason/Pat/Rose/Grace | main | `summary.hs_data()` marker-status diagnostics | local checks passed | diagnostic only | commit, push, and watch CI/pkgdown |
