...
| 2026-06-13 | R | Emmy/Pat/Rose/Grace | main | `coef()` and `nobs()` for `hsquared_fit` | local checks passed | S3 ergonomics only; no new fitting | push, watch CI, notify issue #5 |
