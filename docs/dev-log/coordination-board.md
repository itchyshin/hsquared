...
| 2026-06-13 | R/docs | Ada/Shannon/Boole/Hopper/Emmy/Grace/Rose/Pat | main | mission-control pkgdown article | local checks passed | dashboard only; no new fitting | push and watch CI/pkgdown/Pages |
