...
| 2026-06-13 | R | Emmy/Henderson/Pat/Rose/Grace | main | `summary.hs_data()` pedigree-status diagnostics | local checks passed | diagnostic only | commit, push, and watch CI/pkgdown |
