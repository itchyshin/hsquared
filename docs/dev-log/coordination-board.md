...
| 2026-06-13 | R | Emmy/Jason/Pat/Rose/Grace | main | `hs_data()` genotype-status diagnostics | local checks passed | diagnostic only; no genomic/QTL model terms | push, watch CI/pkgdown/Pages, notify issue #8 and Julia twin |
