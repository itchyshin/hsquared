...
| 2026-06-13 | R | Emmy/Pat/Fisher/Rose/Grace | main | `fitted()` and `residuals()` for `hsquared_fit` | local checks passed | extractor ergonomics only; no new fitting | push, watch CI/pkgdown/Pages, notify issue #5 |
