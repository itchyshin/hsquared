...
| 2026-06-13 | R | Curie/Fisher/Pat/Rose/Grace | main | `validation_status()` evidence diagnostics | local checks passed | diagnostic only; does not run checks | push, watch CI/pkgdown/Pages, and notify issue #7 |
