...
| 2026-06-13 | R | Emmy/Darwin/Pat/Rose/Grace | main | `hs_data()` environment-key diagnostics | local checks passed | diagnostic only; no environment-effect model terms | push, watch CI/pkgdown/Pages, notify issue #8 |
