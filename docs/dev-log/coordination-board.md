...
| 2026-06-13 | R | Emmy/Jason/Pat/Rose/Grace | main | `hs_data()` expression-status diagnostics | local checks passed | diagnostic only; no eQTL/omics model terms | push, watch CI/pkgdown/Pages, notify issue #8 and Julia twin |
