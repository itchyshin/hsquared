...
| 2026-06-13 | R | Hopper/Lovelace/Karpinski/Grace/Rose | main | sparse `Z` CSC marshalling for issue #6 | local checks passed | production fitting still planned | push sparse bridge and watch CI/pkgdown |
