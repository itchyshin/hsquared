...
optional dense validation-path PEV/reliability with Julia when available.
Optional local tests also compare Julia dense REML and sparse REML likelihood
evaluators on a tiny supplied-variance three-founder fixture. Use
