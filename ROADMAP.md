...
- Common environment and maternal-genetic — opt-in, experimental
  ...
  two independent effects. The correlated direct–maternal (2×2 G) model remains
  planned.
- Sire models.
...
- Building `Ginv`/`G` from markers, SNP-BLUP, `Hinv`/single-step HBLUP, APY,
  low-rank m≫n solves, genomic feature/QTL-style effects, comparator parity
