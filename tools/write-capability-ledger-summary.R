  ...
  list(
    ...
    list(
      ...
      scope = paste(
        ...
        "agreement probe - which is NOT same-estimand REML parity. The Mrode",
        "anchor is SUPPLIED-covariance (fixed effects and BLUPs given known",
        "G0/R0), so it does NOT anchor the ESTIMATED G0/R0, and no published",
        "textbook anchor for estimated multivariate G0/R0 exists - that evidence",
