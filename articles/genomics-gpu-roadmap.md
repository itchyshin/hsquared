...
`docs/design/07-genomics-qtl-gpu-plan.md`. This article is the
user-facing map.
...
For expression and high-dimensional omics, the long-run plan is to
combine marker scans, sample factors, and genomic relatedness:
...
Classical multivariate animal models and GLLVM-style models should sit
on one ladder:
